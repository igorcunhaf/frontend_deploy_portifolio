...
export default function IntranetPage() {
  ...
  const handleEditProject = async (id: number, projectData: { title: string, description: string }) => {
    const token = getToken();
    try {
  ...
  const handleEditPost = async (id: number, postData: { title: string, content: string }) => {
    const token = getToken();
    try {
